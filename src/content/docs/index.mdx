---
title: "BibTeX Guide for LaTeX: References, Bib Files, and Better Workflows"
description: "Learn BibTeX step by step with a technical, practical guide for LaTeX users. Understand BibTeX vs BibLaTeX, avoid common manual errors, and use modern BibTeX management tools."
sidebar:
  label: BibTeX and LaTeX (Quick start)
---
...
- [BibTeX entry types](/types)
- [BibTeX FAQ](/faq)
- [BibTeX converters](/converters)
