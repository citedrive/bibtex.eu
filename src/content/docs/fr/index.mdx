...
sidebar:
  label: Gestion bibliographique avec LaTeX et BibTeX (Démarrage rapide)
---
...
- Zotero offre des fonctionnalités étendues et une bonne intégration avec BibTeX grâce à l'extension [Better BibTeX For Zotero](https://retorque.re/zotero-better-bibtex/).
- JabRef est un gestionnaire de références basé sur BibTeX qui fonctionne sur plusieurs plateformes.