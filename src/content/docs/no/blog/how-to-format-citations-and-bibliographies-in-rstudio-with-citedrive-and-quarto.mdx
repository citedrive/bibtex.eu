...
CiteDrive - Eksempel](@assets/images/tutorial/citedrive_copy_citation.gif)

Lim inn referansenøkkelen i det nødvendige avsnittet i Quarto-dokumentet ditt.

![CiteDrive - Lim inn siteringsnøkkel](@assets/images/tutorial/citedrive_paste_citation_rstudio.gif)
