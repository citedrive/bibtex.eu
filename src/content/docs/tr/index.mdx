...
sidebar:
  label: LaTeX ile BibTeX Kaynakça Yönetimi (Başlangıç Rehberi)
---
...
- Zotero geniş özellikler sunar ve [Better BibTeX For Zotero](https://retorque.re/zotero-better-bibtex/) eklentisi ile BibTeX'e iyi bir entegrasyon sağlar.
- JabRef platformlar arası çalışabilen BibTeX tabanlı bir referans yöneticisidir.