---
title: Guia BibTeX para LaTeX - gerenciamento bibliografico com arquivos .bib
description: "Guia tecnico de BibTeX para LaTeX: funcionamento, BibTeX vs BibLaTeX, limites da edicao manual e ferramentas recomendadas."
sidebar:
  label: BibTeX e LaTeX (Inicio rapido)
---
...
- [CiteDrive para workflows BibTeX](./citedrive)