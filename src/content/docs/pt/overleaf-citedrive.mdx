---
title: Overleaf + CiteDrive - Uma poderosa combinação para usuários de LaTeX
description: O CiteDrive é uma plataforma de gerenciamento de referências e citações baseada em nuvem para o Overleaf.
template: splash
hero:
  title: 'Uma poderosa combinação para usuários de LaTeX'
  tagline: 'Complete seu pipeline de pesquisa com a poderosa combinação de Overleaf e CiteDrive. Conecte seu projeto em ambas as aplicações, e seu artigo no Overleaf receberá automaticamente atualizações do seu arquivo BibTeX com apenas alguns cliques.'
  image:
    ...
    alt: "CiteDrive + Overleaf: Gerenciamento de Referências"
  actions:
...
<Card title="Perfeito para o Overleaf!" >
  O Overleaf permite que equipes de estudantes e pesquisadores escrevam artigos simultaneamente, de qualquer lugar, em um editor LaTeX online fácil de usar e colaborativo. O Overleaf suporta uma variedade de pacotes, incluindo o BibTeX, onde você pode gerenciar suas referências. Ao conectar o Overleaf ao CiteDrive, você pode sincronizar automaticamente seu projeto e banco de dados BibTeX com o Overleaf.
</Card>

<CardGrid stagger>
  <Card title="Suporte Nativo BibTeX" icon="approve-check">
    Projetamos nossa infraestrutura para garantir uma entrega BibTeX compatível. Oferecemos suporte a todos os tipos oficiais de entrada e campos, que podem ser inseridos ou importados facilmente com um clique usando nosso plug-in para navegador: sem o uso tedioso de conversores ou manipulação manual. Seu projeto está sempre atualizado para o Overleaf e de uma maneira que o LaTeX irá suportar.
  </Card>
  <Card title="Coleta e Organização" icon="approve-check">
    Equipes maiores que trabalham em um único projeto podem entrar rapidamente em confusão e frustração ao atualizar manualmente as referências em bancos de dados BibTeX (.bib-file), e erros podem ocorrer rapidamente. Com o CiteDrive, você pode adicionar referências facilmente com um clique, graças à extensão do navegador, e agrupar as referências de forma organizada simplesmente arrastando e soltando.
  </Card>
  <Card title="Totalmente Colaborativo" icon="approve-check">
    Sabemos como a colaboração é essencial para os cientistas. Ferramentas abrangentes para equipes tornaram-se comuns e, o mais importante, os artigos raramente são escritos sozinhos. Por isso, construímos nossa plataforma para colaboração. Adicione colegas ao seu projeto a qualquer momento. Você e sua equipe coletam, estruturam e anotam referências e materiais para o seu trabalho, organizados de forma clara em um único projeto.
  </Card>
