...
![CiteDrive - Example](@assets/images/tutorial/citedrive_project_example.png)
...
![CiteDrive-例子](@assets/images/tutorial/citedrive_copy_citation.gif)

在Quarto文件的必要段落中粘贴你的引文关键词。

![CiteDrive - Paste citationkey](@assets/images/tutorial/citedrive_paste_citation_rstudio.gif)
