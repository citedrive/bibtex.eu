---
title: "adfathesis BibTeX style: LaTeX citations, references & Overleaf"
description: "Learn how the adfathesis .bst bibliography style formats citations and references in LaTeX. Step-by-step Overleaf setup, a ready-to-paste BibTeX example, and how CiteDrive helps you manage BibTeX and BibLaTeX for Overleaf projects."
---

import CiteDrive from '@components/CiteDrive.astro';

## General use of the adfathesis style

The **adfathesis** style is implemented as a BibTeX `.bst` file. It defines how your reference list is sorted, labeled, and punctuated when you pair it with a `.bib` database. The sections below summarize how BibTeX styles work in general, then how to use **adfathesis** in Overleaf, and how **CiteDrive** can keep your BibTeX and BibLaTeX libraries in sync with Overleaf.
...
## Using the adfathesis style on Overleaf

Can you use the **adfathesis** BibTeX bibliography style in Overleaf?
...
\documentclass{article}
  ...
  \title{A LaTeX example of BibTeX references using the adfathesis bibliography style.}
  \author{John Smith}
  ...
  \bibliographystyle{adfathesis} % here load adfathesis.bst
