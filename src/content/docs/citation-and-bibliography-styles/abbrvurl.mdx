---
title: "abbrvurl BibTeX style: LaTeX citations, references & Overleaf"
description: "Learn how the abbrvurl .bst bibliography style formats citations and references in LaTeX. Step-by-step Overleaf setup, a ready-to-paste BibTeX example, and how CiteDrive helps you manage BibTeX and BibLaTeX for Overleaf projects."
---
...
Can you use the **abbrvurl** BibTeX bibliography style in Overleaf?
...
\documentclass{article}
  ...
  \title{A LaTeX example of BibTeX references using the abbrvurl bibliography style.}
  \author{John Smith}
  ...
  \bibliographystyle{abbrvurl} % here load abbrvurl.bst
