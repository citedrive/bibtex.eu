...
![CiteDrive - Example](@assets/images/tutorial/browserextension-search-doi.png)

After that, you'll see a BibTeX entry preview where you may change it before saving it to a project of your choosing.

![CiteDrive - Example](@assets/images/tutorial/browserextension-bibtex-preview.png)
...
![CiteDrive - Example](@assets/images/tutorial/citedrive-search-doi.png)
