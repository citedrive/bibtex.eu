---
title: Overleaf + CiteDrive - Una potente combinazione per gli utenti di LaTeX
description: CiteDrive è una piattaforma di gestione delle citazioni basata su cloud per Overleaf.
template: splash
hero:
  title: 'Una potente combinazione per gli utenti di LaTeX'
  tagline: 'Completa la tua pipeline di ricerca con la potente combinazione di Overleaf e CiteDrive. Connetti il tuo progetto su entrambe le app e il tuo articolo su Overleaf riceverà automaticamente gli aggiornamenti dal tuo file BibTeX con pochi clic.'
  image:
    ...
    alt: "CiteDrive + Overleaf: Gestione delle citazioni"
  actions:
    - text: PROVALO GRATIS
...
<Card title="Perfetto per Overleaf!" >
  Overleaf consente a team di studenti e ricercatori di scrivere articoli contemporaneamente, da qualsiasi luogo, in un facile editor LaTeX collaborativo online. Overleaf supporta una varietà di pacchetti, inclusi BibTeX, dove è possibile gestire le referenze. Quando connetti Overleaf a CiteDrive, puoi sincronizzare automaticamente il tuo progetto e il tuo database BibTeX con Overleaf.
</Card>

<CardGrid stagger>
  <Card title="Supporto nativo BibTeX" icon="approve-check">
    Abbiamo progettato la nostra infrastruttura per garantire una consegna conforme di BibTeX. Supportiamo tutti i tipi di voce e campi ufficiali, che possono essere facilmente inseriti o importati con un clic utilizzando il nostro plug-in per il browser: niente noioso utilizzo di convertitori o gestione manuale. Il tuo progetto è sempre aggiornato per Overleaf e in un formato che LaTeX supporterà.
  </Card>
  <Card title="Raccogli e organizza" icon="approve-check">
    Team più grandi che lavorano su un singolo progetto possono facilmente incappare in confusione e frustrazione durante l'aggiornamento manuale delle referenze nei database BibTeX (.bib-file) e gli errori possono verificarsi rapidamente. Con CiteDrive, puoi facilmente aggiungere referenze con un clic grazie all'estensione del browser e raggruppare le referenze in modo ordinato trascinandole e rilasciandole.
  </Card>
  <Card title="Totalmente collaborativo" icon="approve-check">
    Sappiamo quanto sia essenziale il lavoro di squadra per gli scienziati. Gli strumenti completi per i team sono diventati comuni e, soprattutto, gli articoli raramente vengono scritti da soli. Abbiamo quindi costruito la nostra piattaforma per la collaborazione. Aggiungi colleghi al tuo progetto in qualsiasi momento. Tu e il tuo team raccogliete, strutturate e annotate referenze e materiale per il tuo lavoro, chiaramente organizzato in un unico progetto.
  </Card>
