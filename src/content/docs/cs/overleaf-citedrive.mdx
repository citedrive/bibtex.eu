---
title: Overleaf + CiteDrive - Výkonná kombinace pro uživatele LaTeXu
description: CiteDrive je platforma pro správu referencí a citací s prioritou v cloudu pro Overleaf.
template: splash
hero:
  title: 'Výkonná kombinace pro uživatele LaTeXu'
  tagline: 'Dokončete svůj výzkumný proces pomocí výkonné kombinace Overleaf a CiteDrive. Připojte svůj projekt do obou aplikací a váš článek v Overleaf automaticky obdrží aktualizace z vašeho souboru BibTeX pouze pár kliknutími.'
  image:
    ...
    alt: "CiteDrive + Overleaf: Správa referencí"
  actions:
    - text: VYZKOUŠEJTE ZDARMA
...
<Card title="Ideální pro Overleaf!" >
  Overleaf umožňuje týmům studentů a výzkumníků psát články současně odkudkoliv ve snadno použitelném, spolupracujícím online editoru LaTeXu. Overleaf podporuje různé balíčky, včetně BibTeXu, kde můžete spravovat své reference. Když připojíte Overleaf k CiteDrive, váš projekt a BibTeX-databáze se automaticky synchronizují s Overleaf.
</Card>

<CardGrid stagger>
  <Card title="Podpora nativního BibTeXu" icon="approve-check">
    Navrhli jsme naši infrastrukturu tak, aby byla plně kompatibilní s doručením BibTeXu. Podporujeme všechny oficiální vstupní a pole typy, které lze snadno zadat nebo importovat jedním kliknutím pomocí našeho pluginu do prohlížeče: žádné zdlouhavé používání konvertorů nebo manuální manipulace. Váš projekt je vždy udržován aktuální pro Overleaf a tak, aby ho LaTeX podporoval.
  </Card>
  <Card title="Sbírejte a organizujte" icon="approve-check">
    Větší týmy pracující na jednom projektu se rychle mohou dostat do zmatku a frustrace při ruční aktualizaci referencí v databázích BibTeXu (.bib-souboru) a chyby se mohou rychle objevit. S CiteDrive můžete snadno přidávat reference jedním kliknutím díky rozšíření prohlížeče a řadit reference jednoduše přetažením.
  </Card>
  <Card title="Plně spolupracující" icon="approve-check">
    Víme, jak je pro vědce podstatná spolupráce. Nástroje pro týmy jsou již běžné, a co je nejdůležitější, články se zřídka píší samy. Proto jsme postavili naši platformu pro spolupráci. Kdykoliv můžete přidat kolegy do svého projektu. Vy a váš tým shromažďujete, strukturuje a anotujete reference a materiál pro svou práci, jasně organizované v jednom projektu.
  </Card>
