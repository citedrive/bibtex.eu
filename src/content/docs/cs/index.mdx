...
sidebar:
  label: LaTeX Literární správa s BibTeX (Rychlý start)
...
- Zotero nabízí rozsáhlé funkce a dobrou integraci s BibTeXem prostřednictvím doplňku [Better BibTeX For Zotero](https://retorque.re/zotero-better-bibtex/).
