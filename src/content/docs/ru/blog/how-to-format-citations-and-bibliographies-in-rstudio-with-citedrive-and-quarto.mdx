...
![CiteDrive - Пример](@assets/images/tutorial/citedrive_copy_citation.gif)

Вставьте ключ цитирования в нужный фрагмент документа Quarto.

![CiteDrive - Вставить ключ цитирования](@assets/images/tutorial/citedrive_paste_citation_rstudio.gif)
