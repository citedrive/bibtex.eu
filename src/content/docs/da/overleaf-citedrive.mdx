---
title: Overleaf + CiteDrive - Et kraftfuldt makkerpar for LaTeX-brugere
description: CiteDrive er en skybaseret platform til reference- og citatstyring til Overleaf.
template: splash
hero:
  title: 'Et kraftfuldt makkerpar for LaTeX-brugere'
  tagline: 'Fuldfør din forskningspipeline med den kraftfulde kombination af Overleaf og CiteDrive. Forbind dit projekt på begge apps, og din Overleaf-artikel vil automatisk modtage opdateringer fra din BibTeX-fil med blot nogle få klik.'
  image:
    ...
    alt: "CiteDrive + Overleaf: Referencestyring"
  actions:
    - text: PRØV GRATIS
...
<Card title="Perfekt til Overleaf!" >
  Overleaf gør det muligt for hold af studerende og forskere at skrive artikler samtidig, fra hvor som helst, i en nemt anvendelig, samarbejdende online LaTeX-editor. Overleaf understøtter forskellige pakker, herunder BibTeX, hvor du kan administrere dine referencer. Når du forbinder Overleaf med CiteDrive, kan du automatisk synkronisere dit projekt og BibTeX-databasen med Overleaf.
</Card>

<CardGrid stagger>
  <Card title="Naturlig BibTeX-support" icon="approve-check">
    Vi har designet vores infrastruktur for at sikre overholdelse af BibTeX-levering. Vi understøtter alle officielle indtastnings- og felttyper, som nemt kan indtastes eller importeres med ét klik ved hjælp af vores browser-plugin: ingen besværlig brug af konvertere eller manuel håndtering. Dit projekt holdes altid opdateret til Overleaf og på en måde, som LaTeX vil understøtte.
  </Card>
  <Card title="Indsamling og organisering" icon="approve-check">
    Større hold, der arbejder på et enkelt projekt, kan hurtigt støde på forvirring og frustration ved manuel opdatering af referencer i BibTeX-databaser (.bib-fil), og fejl kan hurtigt opstå. Med CiteDrive kan du nemt tilføje referencer med ét klik takket være browserudvidelsen og gruppere referencerne ordentligt ved blot at trække og slippe.
  </Card>
  <Card title="Fuldt samarbejdende" icon="approve-check">
    Vi ved, hvor vigtigt teamwork er for videnskabsfolk. Omfattende værktøjer til hold er blevet almindelige, og vigtigst af alt skrives artikler sjældent alene. Derfor har vi bygget vores platform til samarbejde. Tilføj kolleger til dit projekt når som helst. Du og dit team indsamler, strukturerer og annoterer referencer og materiale til dit arbejde, tydeligt organiseret i ét projekt.
  </Card>
