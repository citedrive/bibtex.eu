...
desription: CiteDrive is a cloud-first reference and citation management platform for Overleaf. 
template: splash
hero:
  title: 'A mighty pairing for LaTeX users'
  tagline: 'Complete your research pipeline with the powerful one-two combination of Overleaf and CiteDrive. Connect your project across both apps and your Overleaf paper will automatically receive updates from your BibTeX file with just a few clicks.'
  image:
    alt: "CiteDrive + Overleaf: Reference Management"
...
<Card title="Perfect for Overleaf!" >
...
<CardGrid stagger>
	<Card title="Native BibTeX support" icon="approve-check">
	...
	<Card title="Collect and organize" icon="approve-check">
	...
	<Card title="Fully collaborative" icon="approve-check">
