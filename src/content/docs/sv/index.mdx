...
sidebar:
  label: Litteraturhantering i LaTeX med BibTeX (Snabbstart)
---
...
- Zotero erbjuder omfattande funktioner och bra integration med BibTeX genom tillägget [Better BibTeX For Zotero](https://retorque.re/zotero-better-bibtex/).
