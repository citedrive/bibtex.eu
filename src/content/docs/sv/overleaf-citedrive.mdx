---
title: Overleaf + CiteDrive - En kraftfull kombination för LaTeX-användare
description: CiteDrive är en molnbaserad plattform för referens- och citathantering för Overleaf.
template: splash
hero:
  title: 'En kraftfull kombination för LaTeX-användare'
  tagline: 'Fullborda din forskningspipeline med den kraftfulla kombinationen av Overleaf och CiteDrive. Anslut ditt projekt till båda apparna, och din Overleaf-artikel kommer automatiskt att uppdateras från din BibTeX-fil med bara några klick.'
  image:
    ...
    alt: "CiteDrive + Overleaf: Referenshantering"
  actions:
    - text: PROVA GRATIS
...
<Card title="Perfekt för Overleaf!" >
  Overleaf möjliggör för team av studenter och forskare att skriva artiklar samtidigt, var som helst, i en användarvänlig, samarbetsvänlig online LaTeX-redigerare. Overleaf stöder olika paket, inklusive BibTeX, där du kan hantera dina referenser. När du ansluter Overleaf till CiteDrive kan du automatiskt synkronisera ditt projekt och din BibTeX-databas med Overleaf.
</Card>

<CardGrid stagger>
  <Card title="Naturligt stöd för BibTeX" icon="approve-check">
    Vi har utformat vår infrastruktur för att säkerställa en BibTeX-leverans i enlighet med standarden. Vi stöder alla officiella typer av poster och fält, som kan läggas in eller importeras enkelt med ett klick med hjälp av vår webbläsartillägg: inget tråkigt användande av omvandlare eller manuell hantering. Ditt projekt är alltid uppdaterat för Overleaf och på ett sätt som LaTeX kommer att stödja.
  </Card>
  <Card title="Samla och organisera" icon="approve-check">
    Större team som arbetar på ett gemensamt projekt kan snabbt stöta på förvirring och frustration vid manuell uppdatering av referenser i BibTeX-databaser (.bib-fil), och misstag kan snabbt uppstå. Med CiteDrive kan du enkelt lägga till referenser med ett klick tack vare webbläsartillägget och gruppera referenser på ett ordnat sätt genom att helt enkelt dra och släppa.
  </Card>
  <Card title="Fullständigt samarbete" icon="approve-check">
    Vi vet hur viktigt samarbete är för forskare. Omfattande verktyg för team har blivit vardagliga, och framför allt skrivs sällan artiklar ensamma. Vi har därför byggt vår plattform för samarbete. Lägg till kollegor i ditt projekt när som helst. Du och ditt team samlar, strukturerar och annoterar referenser och material för ditt arbete, tydligt organiserat i ett projekt.
  </Card>
