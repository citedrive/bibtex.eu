---
title: Overleaf + CiteDrive - Eine mächtige Kombination für LaTeX-Benutzer
description: CiteDrive ist eine Cloud-First-Plattform für Referenz- und Zitierverwaltung für Overleaf.
template: splash
hero:
  title: 'Eine mächtige Kombination für LaTeX-Benutzer'
  tagline: 'Vervollständigen Sie Ihre Forschungspipeline mit der kraftvollen Kombination von Overleaf und CiteDrive. Verbinden Sie Ihr Projekt über beide Apps, und Ihr Overleaf-Papier erhält automatisch Aktualisierungen aus Ihrer BibTeX-Datei mit nur wenigen Klicks.'
  image:
    ...
    alt: "CiteDrive + Overleaf: Referenzverwaltung"
  actions:
...
<Card title="Perfekt für Overleaf!" >
  Overleaf ermöglicht es Teams von Studenten und Forschern, gleichzeitig von überall aus in einem einfach zu bedienenden, gemeinschaftlichen Online-LaTeX-Editor Artikel zu schreiben. Overleaf unterstützt verschiedene Pakete, einschließlich BibTeX, in dem Sie Ihre Referenzen verwalten können. Wenn Sie Overleaf mit CiteDrive verbinden, können Sie Ihr Projekt und Ihre BibTeX-Datenbank automatisch mit Overleaf synchronisieren.
</Card>

<CardGrid stagger>
  <Card title="Native BibTeX-Unterstützung" icon="approve-check">
    Wir haben unsere Infrastruktur entworfen, um eine konforme BibTeX-Lieferung zu gewährleisten. Wir unterstützen alle offiziellen Eintrags- und Feldtypen, die mit nur einem Klick über unser Browser-Plugin leicht eingegeben oder importiert werden können: Keine mühsame Verwendung von Konvertern oder manuelle Handhabung. Ihr Projekt wird immer für Overleaf auf dem neuesten Stand gehalten und auf eine Weise, die von LaTeX unterstützt wird.
  </Card>
  <Card title="Sammeln und organisieren" icon="approve-check">
    Größere Teams, die an einem einzigen Projekt arbeiten, können bei der manuellen Aktualisierung von Referenzen in BibTeX-Datenbanken (.bib-Datei) schnell auf Verwirrung und Frustration stoßen, und Fehler können schnell auftreten. Mit CiteDrive können Sie Referenzen mit nur einem Klick einfach über die Browser-Erweiterung hinzufügen und die Referenzen ordentlich per Drag & Drop gruppieren.
  </Card>
  <Card title="Vollständig kollaborativ" icon="approve-check">
    Wir wissen, wie wichtig Teamarbeit für Wissenschaftler ist. Umfassende Werkzeuge für Teams sind mittlerweile üblich geworden, und vor allem werden Artikel selten allein geschrieben. Daher haben wir unsere Plattform für die Zusammenarbeit aufgebaut. Fügen Sie Kollegen jederzeit zu Ihrem Projekt hinzu. Sie und Ihr Team sammeln, strukturieren und annotieren Referenzen und Material für Ihre Arbeit, übersichtlich organisiert in einem Projekt.
  </Card>
