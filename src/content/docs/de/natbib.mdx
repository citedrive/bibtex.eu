...
sidebar: {
	label: "Bei der verwendung von natbib (Schnellstart)"
}
---
...
```
![Ein kurzer Leitfaden zur Verwaltung von Referenzen mit natbib und BibTeX](@assets/images/tutorial/output_example_bibtex_natbib.png)
...
```
![Ein kurzer Leitfaden zur Verwaltung von Referenzen mit natbib und BibTeX](@assets/images/tutorial/output_example_bibtex_natbib_numeric.png)
