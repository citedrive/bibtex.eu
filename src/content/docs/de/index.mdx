...
sidebar:
  label: LaTeX Literaturverwaltung mit BibTeX (Schnellstart)
---
...
- Zotero bietet umfangreiche Funktionen und eine gute Integration in BibTeX durch das Add-on [Better BibTeX For Zotero](https://retorque.re/zotero-better-bibtex/).
- JabRef ist ein BibTeX-basierter Referenzmanager, der plattformübergreifend funktioniert.