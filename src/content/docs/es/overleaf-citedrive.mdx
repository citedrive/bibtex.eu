---
title: Overleaf + CiteDrive - Una poderosa combinación para usuarios de LaTeX
description: CiteDrive es una plataforma de gestión de referencias y citas basada en la nube para Overleaf.
template: splash
hero:
  title: 'Una poderosa combinación para usuarios de LaTeX'
  tagline: 'Completa tu cadena de investigación con la potente combinación de Overleaf y CiteDrive. Conecta tu proyecto en ambas aplicaciones y tu artículo de Overleaf recibirá automáticamente actualizaciones desde tu archivo BibTeX con solo unos pocos clics.'
  image:
    ...
    alt: "CiteDrive + Overleaf: Gestión de referencias"
  actions:
...
<Card title="¡Perfecto para Overleaf!" >
  Overleaf permite que equipos de estudiantes e investigadores escriban artículos simultáneamente desde cualquier lugar, en un editor LaTeX en línea fácil de usar y colaborativo. Overleaf admite una variedad de paquetes, incluido BibTeX, donde puedes gestionar tus referencias. Cuando conectas Overleaf con CiteDrive, puedes sincronizar automáticamente tu proyecto y tu base de datos BibTeX con Overleaf.
</Card>

<CardGrid stagger>
  <Card title="Soporte nativo de BibTeX" icon="approve-check">
    Diseñamos nuestra infraestructura para garantizar una entrega de BibTeX conforme. Soportamos todos los tipos de entrada y campos oficiales, que se pueden ingresar o importar fácilmente con un solo clic mediante nuestro complemento para el navegador: sin el tedioso uso de convertidores o manipulación manual. Tu proyecto siempre se mantiene actualizado para Overleaf y de una manera que LaTeX admitirá.
  </Card>
  <Card title="Recopila y organiza" icon="approve-check">
    Los equipos más grandes que trabajan en un solo proyecto pueden encontrarse rápidamente con confusión y frustración al actualizar manualmente referencias en bases de datos BibTeX (.bib-file) y los errores pueden ocurrir rápidamente. Con CiteDrive, puedes agregar fácilmente referencias con un clic gracias a la extensión del navegador y agrupar las referencias de manera ordenada simplemente arrastrando y soltando.
  </Card>
  <Card title="Totalmente colaborativo" icon="approve-check">
    Sabemos lo esencial que es el trabajo en equipo para los científicos. Las herramientas completas para equipos se han vuelto comunes y, lo más importante, los artículos rara vez se escriben solos. Por lo tanto, hemos construido nuestra plataforma para la colaboración. Agrega colegas a tu proyecto en cualquier momento. Tú y tu equipo recopilan, estructuran y anotan referencias y material para tu trabajo, claramente organizado en un solo proyecto.
  </Card>
